...
// include: C:\Users\USER\AppData\Local\Temp\tmpnmg49aim.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'samcoupeweb.data';
      var REMOTE_PACKAGE_BASE = 'samcoupeweb.data';
...
Module['FS_createPath']("/", "Resource", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_samcoupeweb.data');
      }
      Module['addRunDependency']('datafile_samcoupeweb.data');
    ...
    loadPackage({"files": [{"filename": "/Resource/SimCoupe.bmp", "start": 0, "end": 4150}, {"filename": "/Resource/atom.rom", "start": 4150, "end": 36918}, {"filename": "/Resource/atomlite.rom", "start": 36918, "end": 69686}, {"filename": "/Resource/samcoupe.rom", "start": 69686, "end": 102454}, {"filename": "/Resource/samcoupelogo.png", "start": 102454, "end": 129168}, {"filename": "/Resource/samcouperobot.png", "start": 129168, "end": 206109}, {"filename": "/Resource/samdos2.map", "start": 206109, "end": 213175}, {"filename": "/Resource/samdos2.sbt", "start": 213175, "end": 223175}, {"filename": "/Resource/samports.map", "start": 223175, "end": 223734}, {"filename": "/Resource/samrom.map", "start": 223734, "end": 260748}, {"filename": "/Resource/sp0256-al2.bin", "start": 260748, "end": 262796}], "remote_package_size": 262796});

  })();

// end include: C:\Users\USER\AppData\Local\Temp\tmpnmg49aim.js
// include: C:\Users\USER\AppData\Local\Temp\tmpa8_ei5h0.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\USER\AppData\Local\Temp\tmpa8_ei5h0.js
// include: C:\Users\USER\AppData\Local\Temp\tmpzo5nvv98.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\USER\AppData\Local\Temp\tmpzo5nvv98.js
...
function findWasmBinary() {
  return locateFile('samcoupeweb.wasm');
}
